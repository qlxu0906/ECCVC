...
parser.add_argument('--data_dir',default='/home/xql/eccv/dataset/pytorch',type=str, help='training dir path')
...
train_data = pd.read_csv('/home/xuqiling/eccvc/dataset/trainGalleriesDF.csv')
train_data = train_data[train_data.pid!='others']
image_datasets = {x:myDataset(df = train_data,path= data_path, name = x ,transform = data_transforms['train'])
                           for x in ['train']}
